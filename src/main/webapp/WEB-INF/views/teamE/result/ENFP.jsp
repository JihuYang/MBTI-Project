...
<div class="result">
    ...
    <img src="../resources/img/teamE/ENFP.jpeg" class="main-animal"/>
	</div>
    ...
    <p class="badRelation">안 맞는 유형 <br> ISTP <br> <img src="<%=request.getContextPath()%>/resources/img/teamE/ISTP.jpeg" class="animals"/> </p> 
