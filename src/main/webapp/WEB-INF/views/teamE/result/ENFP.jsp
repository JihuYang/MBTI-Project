...
<div class="result">
	<div class="box">
	<h1 class="text-c">ENFP <br> 재기발랄한 친구</h1>
    ...
    <p class="text-d">긍정적, 낙천적</p>
    <p class="text-d">사람들이랑 어울리는거 좋아하는 친구</p>
    <p class="text-d">구속받는 걸 싫어하는 친구</p>
    <p class="text-d">충동구매 잘함</p><br>
    </div>
    </div>
    
	
	<p class="goodRelation">잘 맞는 유형 <br> INFJ <br> <img src="../resources/img/teamE/INFJ.jpeg" class="animals"/> </p>
  
    <p class="badRelation">안 맞는 유형 <br> ISTP <br> <img src="../resources/img/teamE/ISTP.jpeg" class="animals"/> </p> 
