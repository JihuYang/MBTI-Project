...
<div class="result">
	<div class="box">
	<h1 class="text-c">INTP <br> 논리적이고 생각이 많은 친구</h1>
    <img src="<%=request.getContextPath()%>/resources/img/teamE/bar.jpg" class="bar"/>
    <img src="<%=request.getContextPath()%>/resources/img/teamE/water.jpg" class="main-animal"/>
	</div>
    
    <div class="outer">
    <div class="resultContent">
    <p class="text-d">게으른 천재</p>
    <p class="text-d">논리적인 친구</p>
    <p class="text-d">남한테 별로 관심 없는 친구</p>
    <p class="text-d">mbti에 그 누구보다 진심인 친구</p><br>
    </div>
    </div>
    
	
	<p class="goodRelation">잘 맞는 유형 <br> ENTJ <br> <img src="<%=request.getContextPath()%>/resources/img/teamE/ENTJ.jpeg" class="animals"/> </p>
