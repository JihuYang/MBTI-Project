...
<body>
   ...
   <div id="question-wrap">
      ...
      <div class= "qBox-wrap">
	      <div class ="q-wrap">
	      	<div class="qBox" style="display: none; height: 812px;">
	      		<p class="q-count"><strong>1</strong><span> / 12</span></p>
	         	<h2><span class="question">바쁜 일정을 끝내고 드디어 쉰다!<br> 무엇을 할까?</span></h2><br>
	         	<div class="option-btn-div">
		         	<button value="q1-1" name="q1" class="option-btn" onclick="location.href='./result'">
		            	<h3>쉴 땐 혼자가 좋아!<br>집에서 혼자만의 시간을 지낸다.</h3>
		         	</button>
	         		<button value="q1-2" name="q1" class="option-btn" onclick="location.href='./result'">
