...
<div id="a_loader" style="display:none;">
	...
	<div class="result-wrap">
		...
		<div class="img-result">
			<img src="<%=request.getContextPath()%>/resources/img/teamB/ENTJ.png" alt="MBTI:결과 img">
		</div>
		<br>
<div class="share-wrap">
		...
		<div class="restarticon">
			...
			<input type="button" value="다시하기"
				...
				onclick="location.href='<%=request.getContextPath()%>/teamB/start'">
			<form method="post"
...
<%-- <%@ include file="<%=request.getContextPath()%>/../../ajaxContent/teamB/comment.jsp"%> --%>
	</div>
	<div class="footer">
