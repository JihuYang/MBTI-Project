	...
	<header class="bg-dark main-header">
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-center text-white">
				...
				<p class="lead fw-normal text-white-50 mb-0">너 자신을 알라! MBTI 통합
					사이트</p>
			</div>
		</div>
	</header>
			...
			<div
					...
					<a href="./teamA/start">
						<div class="card h-100">
							...
							<img class="card-img-top"
								src="resources/img/teamProject/teamA_thumbnail.png"
								alt="<%=request.getContextPath()%>." />
							<!-- Product details-->
				...
				<div class="col mb-3">
					<a href="./teamB/start"><div class="card h-100">
							<!-- Product image-->
							<img class="card-img-top"
								src="resources/img/teamProject/teamB_thumbnail.png"
								alt="<%=request.getContextPath()%>." />
							<!-- Product details-->
							<div class="card-body p-4">
								<div class="text-center">
				...
				<div class="col mb-3">
					<a href="./teamC/start"><div class="card h-100">
							<!-- Product image-->
							<img class="card-img-top"
								src="resources/img/teamProject/teamC_thumbnail.png"
								alt="<%=request.getContextPath()%>." />
							<!-- Product details-->
							<div class="card-body p-4">
								<div class="text-center">
			...
			<div class="container px-4 px-lg-5 mt-5">
				...
				<div
						...
						<div class="card h-100">
							...
							<div class="card-body p-4">
								...
								<div class="d-flex justify-content-center my-2">
									<div>
										<i class="bi bi-caret-right"></i>${views[0]}</div>
								</div>
							</div>
							<!-- Product actions-->
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto" href="./teamA/start">테스트하기
									</a>
								</div>
							</div>
						</div>
					...
					<div class="col mb-5">
						<div class="card h-100">
							...
							<div class="card-body p-4">
								...
								<div class="d-flex justify-content-center my-2">
									<div>
										<i class="bi bi-caret-right"></i>${views[1]}</div>
								</div>
							</div>
							<!-- Product actions-->
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto" href="./teamB/start">테스트하기
									</a>
								</div>
							</div>
						</div>
					...
					<div class="col mb-5">
						<div class="card h-100">
							...
							<div class="card-body p-4">
								...
								<div class="d-flex justify-content-center my-2">
									<div>
										<i class="bi bi-caret-right"></i>${views[2]}</div>
								</div>
							</div>
							<!-- Product actions-->
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto" href="./teamC/start">테스트하기
									</a>
								</div>
							</div>
						</div>
					...
					<%--  <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="resources/img/teamProject/teamD_thumbnail.png" alt="<%=request.getContextPath()%>." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
