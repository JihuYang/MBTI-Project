							...
							<div id="second-section" class="mt-5 border-top-black">
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											<li>모두에게 다정다감한 친절한 개발자. “앗 이건 제가 할게요~!” 단 속마음은 다를 수 있음
												주의!</li>
											<li>게으름? 그게 모야? 계획을 세우고 목적을 향해 돌진!! 모든 일은 신중하고 완벽하게 끝낸다.</li>
											<li>번아웃에 매우 취약한 편 ㅠㅠ 반복적이고 의미없는 일이나 과도한 업무량, 불편한 인간관계는
												나를 지치게 만들어요.</li>
											<li>분쟁과 다툼은 절대 사절. 피할 수 있다면 피하고 싶다. 우리 다 같이 사이좋게 지내요<%=request.getContextPath()%></li>
											<li>사람들 앞에서 내 코드가 비판받은 경우 - 제 코드에 문제가 있나요? 으헝헝헝흐규규규 ㅠㅠ
												ㅠㅠ (대충 2주동안 슬퍼한다)️</li>
										</ul>
									</div>
								</div>
							</div>
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 프로젝트를 실행할때 충분한 시간적 여유가 주어진 일을
											좋아하고, 완벽한 솔루션을 찾는것을 즐기는군요! 새로운 아이디어나 접근 방식을 찾아서 사람과 함께 성장과
											발전을 도울 수 있는 일에도 흥미를 보이네요.</p>
									</div>
									<div id="job" class="text-center">
										<button class="btn btn-light btn-job fs-5">풀스택 개발자</button>
									</div>
									<div class="m-3 fs-6 font-ex">
										<p>풀스택 개발자는 클라이언트 및 서버 사이드 코드를 학습하고 웹 사이트가 작동하도록 해주는 모든
											기술군에 대해 이해하고 있는 개발자입니다. 클라이언트 측에서는 일반적으로 HTML, CSS 및
											JavaScript를 사용하여 웹 사이트에 실제로 표시되는 모든 사항을 개발하 서버 측에서는 클라이언트 측에서
											수신된 데이터를 조작할 수 있는 알고리즘 및 비즈니스 로직을 개발합니다.</p>
									</div>
								</div>
							</div>
									...
									<div class="col pe-0">
										<div id="type-good" class="text-center">
											<button class="btn btn-light btn-type "
												onclick="location.href='ENTP'">
												<div class="type font-ex ">함께하면 좋은</div>
												<div class="mt-3 fs-7">재잘대다 제일 힘든 일 하는</div>
												<h3>아이디어뱅크 개발자</h3>
												<img
													src="<%=request.getContextPath()%>/resources/img/teamA/ENTP.png"
													class="img-type mx-auto d-block" alt="...">
											</button>
										</div>
									</div>
