							...
							<div class="text-left">
								...
								<div class="m-3 me-4 fs-6 font-ex">
									<ul>
										...
										<li>프로젝트 마감이 내일이라구요? 좀만 이따 시작할게요,, 발등에 불이 떨어져서 타들어가도록 미룰 수 있을때까지 일을 끝까지 미룬다. 그런데 어떻게든 다 해내고 심지어 잘해와서 주변 사람들이 깜짝 놀람.</li>
										<li>스트레스 너무 많이 주지 마세요 ㅠㅠ 갑자기 학교나 직장을 때려칠 수도 있다구요.</li>
										<li>내 발자국은 어디에도 남기기 싫어 카톡 프사는 텅텅, 인스타는 눈팅용. 나에 대해 세상에 알리기에는 만사가 다 귀찮다.️</li>
									</ul>
								</div>
							</div>
						</div>
