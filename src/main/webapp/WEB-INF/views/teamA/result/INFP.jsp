					...
					<div class="py-3 window-question bg-white">
						<div id="first-section" class="text-center">
							...
							<div>
								...
								<div class="mt-3 text-muted">당신은 혹시<%=request.getContextPath()%> INFP?</div>
							</div>
						</div>
							...
							<div class="text-left">
								...
								<div class="m-3 me-4 fs-6 font-ex">
									<ul>
										...
										<li>안경을 어디에 뒀더라<%=request.getContextPath()%>? 과제가 언제까지였지<%=request.getContextPath()%>? 현실 감각이 부족해서 작고 사소한 걸 잘 잃어버려요.</li>
