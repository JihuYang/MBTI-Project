								...
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											...
											<li>안경을 어디에 뒀더라<%=request.getContextPath()%>? 과제가 언제까지였지<%=request.getContextPath()%>?
												현실 감각이 부족해서 작고 사소한 걸 잘 잃어버려요.
											</li>
							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 복잡한 상황에서는 인내심을 가지고 잘 견디는 편이지만,
											반복되는 일에는 금방 싫증을 느끼는군요. 조직적인 직무보다는 소규모의 사람들과 함께하는 직무가 잘 어울리네요.</p>
									</div>
									<div id="job" class="text-center">
										<button class="btn btn-light btn-job fs-5">블록체인 개발자</button>
									</div>
									<div class="m-3 fs-6 font-ex">
										<p>블록체인 개발자는 스마트 계약을 개발하고, 블록체인 시스템의 구조나 프레임워크를 정의 및 확립하며,
											따라야 할 시스템에 필요한 프로토콜을 개발한다.</p>
									</div>
								</div>
							</div>
									...
									<div class="col pe-0">
										<div id="type-good" class="text-center">
											<button class="btn btn-light btn-type "
												onclick="location.href='ENFJ'">
												<div class="type font-ex ">함께하면 좋은</div>
												<div class="mt-3 fs-7">프레젠테이션은 내 담당!</div>
												<h3>댕댕이 개발자</h3>
												<img
													src="<%=request.getContextPath()%>/resources/img/teamA/ENFJ.png"
													class="img-type mx-auto d-block" alt="...">
											</button>
										</div>
									</div>
