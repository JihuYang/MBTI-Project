								...
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											...
											<li>저 사람 밑에서 일하느니 차라리 내가 회사를 차리고 말지. 도전하는 것을 겁내지 않는 것이
												나의 제일 큰 장점.</li>
										</ul>
									</div>
								</div>
							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 사람들을 만나는 활동적인 일, 새로운 것에 도전하는 일을
											좋아하는군요! 혼자 일하는 것보다 함께 일할 수 있는 회의 시간에 당신의 매력이 빛을 발할 것 같네요.</p>
									</div>
									<div id="job" class="text-center">
										<button class="btn btn-light btn-job fs-5">IoT 개발자</button>
									</div>
									<div class="m-3 fs-6 font-ex">
										<p>IoT 개발자는 센서 노드와 스마트 기기의 융합을 통해 국가 혹은 도시적인 관점에서 관리되는 센서를
											개인에게 필요한 용도로 사용할 수 있도록 개발합니다. 사물인터넷은 네트워크상에서 정보를 자동으로 전송할 수
											있게 지원해줌으로써, 현명한 결정을 내리고 지속적인 개선과 상호작용을 위한 기반을 제공합니다.</p>
									</div>
								</div>
							</div>
