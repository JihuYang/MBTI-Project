							...
							<div id="second-section" class="mt-5 border-top-black">
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											<li>삶은 거대한 체스<%=request.getContextPath()%>어쩌구<%=request.getContextPath()%>
												운보다는 실력으로, 통찰과 논리로 삶을 살아간다.
											</li>
											<li>철두철미한 목표 지향러. Github에 잔디 심어지는 모습을 보면서 큰 행복감을 느낌.</li>
											<li>목표가 없는 건 견딜 수 없어. 나에게 목표를 심어주세요.</li>
											<li>현실에서는 보기 힘들지만, 지식 공유형 인터넷 커뮤니티 Wiki, Stackoverflow
												등에서는 단연 1위</li>
							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 논리 체계를 이해하려고 논리적인 과정을 통해 결과를
											도출해내네요. 또 어려운 학문을 즐기는 경향이 있고 예측하는 것에 흥미를 느끼는군요!</p>
									</div>
									<div id="job" class="text-center">
										<button class="btn btn-light btn-job fs-5">시스템 엔지니어</button>
									</div>
									<div class="m-3 fs-6 font-ex">
										<p>시스템 엔지니어는 컴퓨터 시스템, OS를 운용하고 관리해요. 또한 서비스에 대한 서버, 네트워크,
											DB 등의 장비를 구축하고 유지보수 및 관리하는 작업을 하며 시스템 설계, 구축, 운영을 담당합니다.</p>
									</div>
								</div>
							</div>
