								...
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											...
											<li>굳이 긴 말이 필요한가요? 관찰하면 되죠. 냉철한 이성주의적 성향과 왕성한 호기심을 가진 만능
												재주꾼.</li>
											<li>자질구레한 것들을 취미 삼아 만드는 걸 좋아한다. 그러나 많은 에너지를 소비하는 것은 NO!</li>
											<li>사람들과 팀플을 하다보면 그런 생각이 들어요 "세상엔 왜 이렇게 멍청한 사람이 많을까" or
												"나는 정말 똑똑한 사람이네".</li>
							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">좋아하는 분야게서 두각을 나타내는 당신, 일의 구조를 명확히
											파악하여 효율성을 극대화 할 수 있는 장점을 지녔군요.</p>
									</div>
									<div id="job" class="text-center">
										<button class="btn btn-light btn-job fs-5">시스템 엔지니어</button>
									</div>
									<div class="m-3 fs-6 font-ex">
										<p>임베디드 개발자는 전자제품이나 기기 내부에 운영체제를 담는 마이크로프세서나 CPU를 개발하는
											개발자입니다. 기계를 잘 다루고 두뇌가 명석한 당신이라면 새로운 접근으로 생성을 증가시킬 수 있을것 같군요!
										</p>
									</div>
								</div>
							</div>
