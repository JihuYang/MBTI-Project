							...
							<div id="first-section" class="text-center">
								...
								<div>
									...
									<img
										...
										class="img-type mx-auto d-block"
								...
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											...
											<li>의식의 흐름대로 이것저것 꼬리에 꼬리를 물고 생각이 흘러감. 내 맥북 색은 스페이스그레이..
												스페이스...우주....우주 정복..??!!</li>
											<li>너 어떻게 그럴 수 있어? (1시간 후) 너와 같이 있어서 행복해.. 작게 자주 삐지지만 몇
												시간 후에 원래대로 돌아온다.</li>
											<li>호불호가 분명하다. 감정 기복이 심하고 감정을 숨길 수가 없음. 어쩔 수 없음.</li>
											<li>스르르 출근하고 스르르 퇴근한다. 출근하자마자 퇴근 시간 기다려지는거~ 나만 그런거
												아니잖아요?️</li>
										</ul>
									</div>
								</div>
							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 창의력 넘치는 아이디어를 많이 가지고 있군요. 혼자보다는
											여러사람이 함께 일할 때 에너지를 얻는 당신, 당신의 창의성을 발휘할 수 있는 직무가 어울리네요.</p>
									</div>
									<div id="job" class="text-center">
										<button class="btn btn-light btn-job fs-5">iOS 앱 개발자</button>
									</div>
									<div class="m-3 fs-6 font-ex">
										<p>iOS 앱 개발자는 iOS 기반 모바일 앱의 화면을 만들고 그 화면을 작동하게 한다. 가장 최신의
											갠쥐나는 아이폰을 사용할것만 같은 당신에게 딱 어울릴것 같은 직무군요!</p>
									</div>
								</div>
							</div>
								...
								<div class="row mt-3">
									<div class="col pe-0">
										<div id="type-good" class="text-center">
											<button class="btn btn-light btn-type "
												onclick="location.href='ISTP'">
												<div class="type font-ex ">함께하면 좋은</div>
												<div class="mt-3 fs-7">사람보다 사물이 더 좋은</div>
												<h3>만능 개발자</h3>
												<img
													src="<%=request.getContextPath()%>/resources/img/teamA/ISTP.png"
									...
									<div class="col ps-0">
										<div id="type-bad" class="text-center">
											<button class="btn btn-light btn-type "
												onclick="location.href='ISTJ'">
												<div class="type font-ex ">멀리하면 좋은</div>
												<div class="mt-3 fs-7">분단위로 계획적이게</div>
												<h3>로보트 개발자</h3>
												<img
													src="<%=request.getContextPath()%>/resources/img/teamA/ISTJ.png"
													class="img-type mx-auto d-block" alt="...">
											</button>
										</div>
									</div>
