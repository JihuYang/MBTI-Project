						...
						<div class="py-3 window-question bg-white">
							<div id="first-section" class="text-center">
								...
								<div>
									<h1>관종 개발자</h1>
									<img
										src="<%=request.getContextPath()%>/resources/img/teamA/ESFP.png"
										class="img-type mx-auto d-block" alt="...">
									<div class="mt-3 text-muted">당신은 혹시.. ESFP?</div>
								</div>
							</div>
								...
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											...
											<li>오늘의 행복을 위해서라면 코딩이고 뭐고 여행이나 갈래. 왜 굳이 힘들게 일하죠? 그냥 모두가
												행복해졌으면 좋겠어!</li>
											<li>다른 사람을 위한 surprise를 준비하며 즐거워 하지만, 정작 뚝딱이 개발자들은 잘
												반응해주지 못하는 걸,,</li>
							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 어떤 상황에도 금방 적응하고, 빨리 배우는군요! 또 타고난
											순발력 덕분에 문제가 생겼을 때 재빨리 대응하는 능력이 뛰어나네요. 진정한 인싸라면 새로나온 게임정도는 다
											알아야 하지 않을까요!?</p>
									</div>
									...
									<div class="m-3 fs-6 font-ex">
										<p>게임 프로그래머는 프로그래밍을 통해 맵 디자인, 캐릭터 디자인, 사운드, 각종 시스템 등을
											뒤섞어, 게임이라는 하나의 결과물을 만든다.</p>
									</div>
								</div>
							</div>
									...
									<div class="col pe-0">
										<div id="type-good" class="text-center">
											<button class="btn btn-light btn-type "
												onclick="location.href='INFP'">
												<div class="type font-ex ">함께하면 좋은</div>
												<div class="mt-3 fs-7">혼자 웃고 있는 힉힉호무리</div>
												<h3>개복치 개발자</h3>
												<img
													src="<%=request.getContextPath()%>/resources/img/teamA/INFP.png"
													class="img-type mx-auto d-block" alt="...">
											</button>
										</div>
									</div>
