							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 안정되고 정통적인 환경에서 일하는 것을 좋아하시는군요.
											결과가 눈에 보이고 예측하는 일을 좋아하는 당신에게는 분석하는 직무가 잘 어울리네요.</p>
									</div>
									...
									<div class="m-3 fs-6 font-ex">
										<p>빅데이터 분석가는 수많은 데이터 속에서 트렌드를 읽어내 부가가치가 높은 결과물을 도출해내는 일을
											담당한다. 대량의 빅데이터를 관리하고 분석해 사람들의 행동패턴이나 시장 경제상황 등을 예측하기도 한답니다.</p>
									</div>
								</div>
							</div>
