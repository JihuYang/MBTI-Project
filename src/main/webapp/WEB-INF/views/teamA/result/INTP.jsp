								...
								<div class="text-left">
									...
									<div class="m-3 me-4 fs-6 font-ex">
										<ul>
											...
											<li>타고난 논리력으로 글은 잘 쓰지만, 그걸 말로 표현하는 것은 어려워 함. 내 머릿속에서
												흘러가는 사고는 말로 설명할 수 없을 만큼 빠르거든요.</li>
											<li>꼰대들이 가장 싫어하는 유형. 엇, 그런데 저도 꼰대를 제일 싫어하는 걸요!? 피차 싫어하니
												상관 없음.</li>
											<li>계획을 철저하게 짤 수 있지만 즉흥적으로 행동할 가능성도 매우 높음. 계획이 전부가
												아니라구!️</li>
										</ul>
									</div>
								</div>
							...
							<div id="third-section" class="mt-5 border-top-black">
								<div class="text-center">
									...
									<div class="m-3 fs-6 font-ex">
										<p class="text-muted">당신은 근본적인 문제를 파악하고, 불일치나 결함 등도 신속하게
											파악할 수 있네요. 또한 문제를 해결하기 위해 장기적인 전략과 계획을 세우고 실현하는 사람이네요.</p>
									</div>
									<div id="job" class="text-center">
										<button class="btn btn-light btn-job fs-5">소프트웨어 엔지니어</button>
									</div>
									<div class="m-3 fs-6 font-ex">
										<p>소프트웨어 엔지이어는 소프트웨어를 설계/분석하고 우수한 품질을 위해 테스트를 반복해요. 직접
											코딩하기도 하지만 대부분 프로그래머들에게 지침을 제공합니다. 근본적인 문제를 파악하고 해결책을 세우는 당신과
											딱 어울리는 직무네요!</p>
									</div>
								</div>
							</div>
									...
									<div class="col pe-0">
										<div id="type-good" class="text-center">
											<button class="btn btn-light btn-type "
												onclick="location.href='ENTJ'">
												<div class="type font-ex ">함께하면 좋은</div>
												<div class="mt-3 fs-7">갑질 가능성 99.9%</div>
												<h3>타고난 리더 개발자</h3>
												<img
													src="<%=request.getContextPath()%>/resources/img/teamA/ENTJ.png"
													class="img-type mx-auto d-block" alt="...">
											</button>
										</div>
									</div>
